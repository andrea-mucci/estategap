...
def _build_normalized_listing(raw: RawListing, mapped: dict[str, Any]) -> NormalizedListing:
    ...
    payload: dict[str, Any] = {
        ...
        "built_area_sqft": mapped.get("built_area_sqft"),
        "built_area_m2": mapped["built_area_m2"],
        "usable_area_m2": mapped.get("usable_area_m2"),
        "plot_area_m2": mapped.get("plot_area_m2"),
        "lot_size_sqft": mapped.get("lot_size_sqft"),
        "lot_size_m2": mapped.get("lot_size_m2"),
        ...
        "hoa_fees_monthly_usd": mapped.get("hoa_fees_monthly_usd"),
        "tax_assessed_value_usd": mapped.get("tax_assessed_value_usd"),
        "school_rating": mapped.get("school_rating"),
        "zestimate_reference_usd": mapped.get("zestimate_reference_usd"),
        "compete_score": mapped.get("compete_score"),
        "mls_id": _string_or_none(mapped.get("mls_id")),
