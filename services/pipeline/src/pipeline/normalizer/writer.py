...
ON CONFLICT (source, source_id, country) DO UPDATE SET
    ...
    built_area_sqft = EXCLUDED.built_area_sqft,
    ...
    leasehold_years_remaining = EXCLUDED.leasehold_years_remaining,
    seller_type = EXCLUDED.seller_type,
    bag_id = EXCLUDED.bag_id,
    hoa_fees_monthly_usd = EXCLUDED.hoa_fees_monthly_usd,
    lot_size_sqft = EXCLUDED.lot_size_sqft,
    lot_size_m2 = EXCLUDED.lot_size_m2,
    tax_assessed_value_usd = EXCLUDED.tax_assessed_value_usd,
    school_rating = EXCLUDED.school_rating,
    zestimate_reference_usd = EXCLUDED.zestimate_reference_usd,
    compete_score = EXCLUDED.compete_score,
...
class ListingWriter:
    ...
    def _listing_tuple(self, listing: NormalizedListing) -> tuple[Any, ...]:
        ...
        return (
            ...
            listing.epc_rating,
            listing.tenure,
            listing.leasehold_years_remaining,
            listing.seller_type,
            listing.bag_id,
            listing.hoa_fees_monthly_usd,
            listing.lot_size_sqft,
            listing.lot_size_m2,
            listing.tax_assessed_value_usd,
            listing.school_rating,
            listing.zestimate_reference_usd,
            listing.compete_score,
            listing.mls_id,
            listing.condition,
