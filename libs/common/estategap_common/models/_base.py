"""Shared Pydantic base model configuration and validators."""
...
ISO_3166_1_ALPHA2: Final[frozenset[str]] = frozenset(
    {
        "AD",
        "AE",
        "AF",
...
ISO_4217: Final[frozenset[str]] = frozenset(
    {
        "AED",
        "AFN",
        "ALL",
...
def validate_country_code(value: str) -> str:
    ...
    if value not in ISO_3166_1_ALPHA2:
        raise ValueError(f"Unsupported ISO 3166-1 alpha-2 code: {value!r}")
    return value
...
def validate_currency_code(value: str) -> str:
    ...
    if value not in ISO_4217:
        raise ValueError(f"Unsupported ISO 4217 alpha-3 code: {value!r}")
    return value
